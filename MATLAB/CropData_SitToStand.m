...
%% Additional code for Sit-TO-Stand experiment
% B버튼 이전만 사용
ok_risings(ok_risings > b_risings) = [];
ok_fallings(ok_fallings > b_risings) = [];
...
%% For Steady State
cropped_STEADY_filename = ['cropped_STEADY_', h5fileName];
